...
### Integrity
- I have strong ethics and morals and believe in acting of services to others or causes aside from self (as you can see below with my volunteer work). I try to always act from a place of compassion, kindness and respect. I have always had a very good relationship with my employers and collegues as I try to always do what's best for the team and will always put in the effort to do the best job I can for you. Some positive feedback I have receieved from my Makers teammates has been: "Emma made sure that everyone had a say. She was also very supportive and ensured that we were doing well emotionally. I strongly believe that her positivity and insistence on constant communication allowed us to work well and effectively together.”, "You are such a support in general. I always feel I can talk to you if I'm having a problem of any kind. I also feel like you are really good at talking about your own problems, and talking through any issues with other people in a non-confrontational and respectful manner.", "When you've explained things to me, I've always felt like it's a super positive experience, talking as equals, and you are always trying to make the emphasis on my learning and how you can help me, and I come away having learnt a lot."

### Inquisitive
- I study, travel, read and paticipate in experiences to constantly learn more about aspects of the world and myself. I don't ever want to stop learning. I am passionate about being a developer as it brings new challenges and teachings into my life every day. I find the ways in which my studies and experiences interweave, fascinating and highly benefitial. My previous Degrees may not have lead to a career in those specific fields. And yet none of them were a waste as aspects of those teachings influence and strengthen all other work I do. A Makers peer gave me the feedback: "What I particularly appreciate about you is that I think that you are just open to learning with no ego or walls involved."

### Logical
- I encouraged our final group project team at Makers to use props when passing data between files instead of using Redux https://github.com/emmaalbury/made-to-help. Considering we were in the midst of learning multiple new frameworks and were running out of time, it felt it could be too much pressure for us to learn another complex aspect of React Native and would be best to just use props. Saying that, I’d like to learn more about and utilise Redux in the future. A teammate on that project gave me the following feedback: "Emma and I paired a lot during our final projects. For 2 days, we were stuck on how to move information from one file to another. We did some research separately to figure out the best way to do it. We found two ways to do it: the first one is through props and the second one is with Redux. After some research, Emma explained to me why using the props was a better option for our project. She believed that Redux was mostly used for bigger projects and as we were running out of time, learning a new technology was not the best idea. She shared with me the resources she found on how to use props in order to move data across different files. After that, we managed to do it successfullly.  She was really good at making sure that I understood why she thought going with props was a better option in that case."
...
2014 - Conservation Internship, MAGNT (Museum and Art Galley of the Northern Territory), Darwin Australia.
...
2011-2015 - Casual Art Handler (Packing, Storage and Transportation of Artwork/Artifacts, Installation and De-Installation of Art and Museum Exhibitions), NGV (National Gallery of Victoria), Melbourne Australia.
...
2007 - Tour Group/ Home Stay Coordinator and ESL (English as a Second Language) Teacher, Imagine Education, Southport Australia.
...
2010 - Assistant Co-ordinator and Audio Visual Technician for NYCEMF (New York City Electro Acoustic Music Festival).
